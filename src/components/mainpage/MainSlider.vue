  ...
  <section class="main">
    ...
    <div class="main__slider">
      <Swiper
          :slides-per-view="1"
          :navigation="{
            prevEl: '.main__slider-nav.prev',
            nextEl: '.main__slider-nav.next',
          }"
      >
        <SwiperSlide>
          <div class="event">
      ...
      <div class="main__slider-nav">
        <button ref="prevEl" type="button" class="main__slider-nav_button prev">
        ...
        <button ref="nextEl" type="button" class="main__slider-nav_button next">
          <svg width="12" height="22" viewBox="0 0 12 22" xmlns="http://www.w3.org/2000/svg">
