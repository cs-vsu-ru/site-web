          ...
          <div class="news-all__field">
            <div v-for="(newsSlide, index) in newsSlider" class="new" v-show="newsShow[index]">
                <div class="slider-admin__box">
                  ...
                  <button @click="saveNews(newsSlide.id, newsSlide.publicationDate, newsSlide.publicationTime, newsSlide.content, newsSlide.title, newsSlide.imageLink, index); newsDisabler[index] = false" v-if="newsDisabler[index]" class="news-admin__button admin-button">Сохранить</button>
              </div>
          </div>
      </div>
      <div class="admin__view-item">
